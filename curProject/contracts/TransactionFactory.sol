...
contract TransactionFactory {
    ...
    */
    ...
    function createTransaction(bytes32 name) public returns(address transAddress) {
        TokenTransaction t = new TokenTransaction(name); 
        contracts.push(t); // adding to contracts array the address
        return t; 
    }
